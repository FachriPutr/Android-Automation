...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Konfirmasi Password' or . = 'Konfirmasi Password') and @resource-id = 'com.nobubank.nobuepay.walletsit:id/label']</locator>
