...
Mobile.setText(findTestObject('TC005/android.widget.EditText-isi nama lengkap'), 'TESTING', 0)
...
Mobile.setText(findTestObject('TC008/android.widget.EditText-input password'), '@Test1No', 0)
...
Mobile.setText(findTestObject('TC008/android.widget.EditText- input konfirmasi password'), '@Test1No', 0)
