...
// Password kosong dan konfirmasi password kosong
...
// Password ada dan konfirmasi password kosong
Mobile.tap(findTestObject('TC008/android.widget.TextView - Buat Password Baru'), 0)

Mobile.tap(findTestObject('TC008/android.widget.TextView - Password'), 0)

Mobile.tap(findTestObject('TC008/android.widget.EditText-input password'), 0)
...
Mobile.tap(findTestObject('TC008/android.widget.EditText- input konfirmasi password'), 0)
...
// Password kosong dan konfirmasi password ada
Mobile.tap(findTestObject('TC008/android.widget.TextView - Buat Password Baru'), 0)

Mobile.tap(findTestObject('TC008/android.widget.TextView - Password'), 0)

Mobile.clearText(findTestObject('TC008/android.widget.EditText-input password'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.clearText(findTestObject('TC008/android.widget.EditText- input konfirmasi password'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('TC008/android.widget.EditText- input konfirmasi password'), 'Fakhriaria27@1', 0)
