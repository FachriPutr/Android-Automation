...
Mobile.tap(findTestObject('i want to isi saldo/android.widget.Button - Isi Saldo'), 0)

//merchant
Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Merchant QRIS'), 0)

Mobile.pressBack()

//ATM
Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - ATM'), 0)

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Bank NOBU(ATM)'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Bank Lain(ATM)'), 0)
...
//Minimarket
Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Minimarket'), 0)

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Alfamart'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Alfamidi'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Dandan'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Lawson'), 0)
...
//IB
Mobile.tap(findTestObject('i want to isi saldo/android.widget.TextView - Internet  Mobile Banking'), 0)

Mobile.tap(findTestObject('i want to isi saldo/tambahan/android.widget.TextView - Bank NOBU (IB)'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/tambahan/android.widget.TextView - NEO(IB)'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('i want to isi saldo/tambahan/android.widget.TextView - Bank Lain(IB)'), 0)
