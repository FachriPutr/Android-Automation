...
Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.widget.LinearLayout-Fitur transfer bank'), 0)

Mobile.tap(findTestObject('Transfer Bank Nobu Account/android.view.ViewGroup - Button Transfer Bank'), 0)

TestData ExcelData = findTestData('savvy/Transfer Nobu Bank Account/DF003-Transfer Nobu Bank account')
