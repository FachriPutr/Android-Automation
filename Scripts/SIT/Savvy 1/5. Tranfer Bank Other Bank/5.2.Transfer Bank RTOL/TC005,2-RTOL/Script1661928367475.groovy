...
TestData ExcelData = findTestData('savvy/Transfer RTOL/DF005.2-Transfer RTOL')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    Mobile.tap(findTestObject('Transfer Bank Nobu Account/android.view.ViewGroup - Bank CIMB Niaga'), 5, FailureHandling.OPTIONAL)
    ...
    Mobile.tap(findTestObject('Transfer Bank Nobu Account/android.view.ViewGroup - RTOL'), 5, FailureHandling.OPTIONAL)

    Mobile.tap(findTestObject('Transfer Bank Nobu Account/android.widget.ImageView - close Tipe transfer'), 5, FailureHandling.OPTIONAL)
    ...
    if (pin != 123456) {
        ...
        Mobile.tap(findTestObject('Transfer Bank Nobu Account/android.widget.Button - Sembunyikan Detail'), 2, FailureHandling.OPTIONAL)
