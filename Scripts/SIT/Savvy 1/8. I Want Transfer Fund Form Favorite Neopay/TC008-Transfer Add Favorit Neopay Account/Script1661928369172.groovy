...
Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.view.ViewGroup - Fakhri Neopay'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('', FailureHandling.STOP_ON_FAILURE)

TestData ExcelData = findTestData('savvy/Transfer Add Favorit Neopay/DF008-Transfer Add Favorite Neopay Account')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    Mobile.tap(findTestObject('Transfer Add Favorite Neopay Account/android.widget.EditText - Nominal Transfer'), 5, FailureHandling.OPTIONAL)

    Mobile.setText(findTestObject('Transfer Add Favorite Neopay Account/android.widget.EditText - Nominal Transfer'), NominalTansfer, 
    ...
    Mobile.tap(findTestObject('Transfer Add Favorite Neopay Account/android.widget.Button - Selanjutnya'), 5, FailureHandling.OPTIONAL)
