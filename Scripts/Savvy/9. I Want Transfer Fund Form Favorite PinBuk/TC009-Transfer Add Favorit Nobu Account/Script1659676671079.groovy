...
Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.widget.TextView - button Transfer'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.widget.TextView - button Favorit'), 0)

//Mobile.tapAtPosition(285, 85)
Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.view.ViewGroup - Bank NOBU Fakhri'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('', FailureHandling.STOP_ON_FAILURE)

TestData ExcelData = findTestData('savvy/Transfer Add Favorit Bank Nobu Account/DF009-Transfer Add Favorite Nobu bank')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    //    int AmountTransfer = Integer.parseInt(ExcelData.getValue(3, i))
    String NominalTansfer = ExcelData.getValue(3, i)

    System.out.println('NominalTransfer : ' + NominalTransfer)

    String pin = ExcelData.getValue(4, i)

    System.out.println('pin : ' + pin)

    Mobile.scrollToText('Transfer ke', FailureHandling.OPTIONAL)

    Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.widget.EditText - Nominal transfer'), 5, FailureHandling.OPTIONAL)

    Mobile.setText(findTestObject('Transfer Add favorit Nobu Account/android.widget.EditText - Nominal transfer'), NominalTansfer, 
    ...
    //    Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.view.ViewGroup - Sumber Dana Neopay'), 5, FailureHandling.OPTIONAL)
    Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.view.ViewGroup - Sumber Dana Nobu'), 5, FailureHandling.OPTIONAL)

    Mobile.scrollToText('Selanjutnya', FailureHandling.STOP_ON_FAILURE)

    Mobile.tap(findTestObject('Transfer Add favorit Nobu Account/android.widget.Button - Selanjutnya'), 5, FailureHandling.OPTIONAL)
