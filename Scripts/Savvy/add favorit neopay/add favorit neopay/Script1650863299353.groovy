...
///TC2-add berhasil
//Masukan no ponsel neopay
Mobile.setText(findTestObject('Neopay Transfer/android.widget.EditText - Input No Ponsel'), '081646948713', 0)

//Masukan Nominal
Mobile.setText(findTestObject('Neopay Transfer/android.widget.EditText - input Nominal Transfer'), '25000', 0)
...
Mobile.tap(findTestObject('Neopay Transfer/android.widget.TextView - Masukkan 6 digit PIN Kamu'), 0)
...
Mobile.tap(findTestObject('i want to isi saldo/android.widget.ImageView - button back'), 0)
...
//Mobile.tap(findTestObject('i want to isi saldo/android.widget.ImageView - button back'), 0)
//
//Mobile.tap(findTestObject('tambah favorit/android.widget.ImageView - visible'), 0)
