...
Mobile.tap(findTestObject('transfer via SKN RTOL RTGS/android.view.ViewGroup - Bank Mandiri'), 0)
...
Mobile.tap(findTestObject('transfer via SKN RTOL RTGS/android.view.ViewGroup - tap tipe transfer'), 0)
