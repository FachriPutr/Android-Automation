...
Mobile.tap(findTestObject('Object Repository/Transfer neopay lewat favorit/android.widget.EditText - tap nominal transfer'), 
    0)

Mobile.setText(findTestObject('Transfer neopay lewat favorit/android.widget.EditText - tap nominal transfer'), '25000', 
    0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/Transfer neopay lewat favorit/android.widget.Button - Selanjutnya'), 0)
