...
//Transfer gagal - no ponsel salah
...
Mobile.setText(findTestObject('Neopay Transfer/android.widget.EditText - Input No Ponsel'), '087805629919', 0)
...
Mobile.tap(findTestObject('Neopay Transfer/android.widget.TextView - No Handphone Tidak Ditemukan'), 0)
