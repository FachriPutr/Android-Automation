...
Mobile.setText(findTestObject('Neopay Transfer/android.widget.EditText - Input No Ponsel'), '085715526866', 0)

Mobile.setText(findTestObject('Neopay Transfer/android.widget.EditText - input Nominal Transfer'), '250000', 0)
