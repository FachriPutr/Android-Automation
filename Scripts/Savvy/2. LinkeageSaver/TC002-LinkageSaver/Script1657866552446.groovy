...
TestData ExcelData = findTestData('savvy/LinkageSAver/DF002-LinkageSAver')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    if ((OTP.length() > 6) || (OTP != '999999')) {
        ...
        Mobile.tap(findTestObject('LinkageSaver/android.widget.ImageView - button back'), 0)
    ...
    Mobile.tap(findTestObject('Daftar/android.widget.EditTextPassword'), 0, FailureHandling.STOP_ON_FAILURE)

    Mobile.setText(findTestObject('Daftar/android.widget.EditTextPassword'), Password, 0, FailureHandling.OPTIONAL)

    Mobile.hideKeyboard()

    //Mobile.scrollToText(KonfirmasiPassword, FailureHandling.OPTIONAL)
    Mobile.tap(findTestObject('Daftar/android.widget.EditTextKonfirmasiPassword'), 0, FailureHandling.STOP_ON_FAILURE)

    Mobile.setText(findTestObject('Daftar/android.widget.EditTextKonfirmasiPassword'), KonfirmasiPassword, 0, FailureHandling.OPTIONAL)
    ...
    Mobile.tap(findTestObject('Daftar/android.widget.Button - Lanjut'), 5, FailureHandling.OPTIONAL)
